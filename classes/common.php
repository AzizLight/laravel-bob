...
class Common
{
    ...
    public static function get_bracket_whitespace()
    {
        $bracket_whitespace_option = Config::get('bob::options.bracket_whitespace');
        $bracket_whitespace = '';
        if ($bracket_whitespace_option === 'sameline')
        {
            $bracket_whitespace .= ' ';
        }
        else if ($bracket_whitespace_option === 'newline')
        {
            $bracket_whitespace .= PHP_EOL;
        }
        else
        {
            static::error('The bracket_whitespace option in the options.php file is not configured correctly');
        }
